...
-- query name: velodrome_sources_optimism
-- query link: https://dune.com/queries/3632727
...
AND (t1.project = 'velodrome' AND t2.project IN ('kyberswap', 'uniswap','woofi', 'curve','balancer', 'synthetix','zipswap') 
OR t2.project = 'velodrome' AND t1.project IN ('kyberswap', 'uniswap','woofi', 'curve','balancer', 'synthetix','zipswap'))
...
('0xcf32c5bb41f7a302298a2d2072155800871baad3', 'Magpie'),
('0x5c4cf9768c857528b025a6de958f803c852fbaf1', 'Kyber')
)
    as t (address, name))
...
UNION ALL
SELECT lower(address), name, 'optimism' as blockchain, 'balancer_source' as type, 'balancerlabs' as author FROM routers
