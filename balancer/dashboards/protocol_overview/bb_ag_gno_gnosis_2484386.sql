...
-- query name: bb-ag-GNO (GNOSIS)
-- query link: https://dune.com/queries/2484386
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0xffff76a3280e95dc855696111c2562da09db2ac000000000000000000000000c] AS pool_ids)
