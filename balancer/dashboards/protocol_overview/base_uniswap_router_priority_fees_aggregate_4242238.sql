...
-- query name: base_uniswap_router_priority_fees_aggregate
-- query link: https://dune.com/queries/4242238
...
SELECT
    APPROX_PERCENTILE(priority_fee, 0.5) AS p50_priority_fee,
    APPROX_PERCENTILE(priority_fee, 0.75) AS p75_priority_fee,
    APPROX_PERCENTILE(priority_fee, 0.90) AS p90_priority_fee,
    APPROX_PERCENTILE(priority_fee, 0.95) AS p95_priority_fee,
    APPROX_PERCENTILE(priority_fee, 0.99) AS p99_priority_fee,
