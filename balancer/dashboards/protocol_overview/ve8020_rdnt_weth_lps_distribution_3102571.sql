...
-- query name: ve8020 RDNT WETH LPs Distribution
-- query link: https://dune.com/queries/3102571
...
WITH joins AS (
        ...
        FROM balancer_v2_arbitrum.transfers_bpt e
   ...
   running_cumulative_bpt_by_pool as (
        ...
        WHERE pool = 0x32df62dc3aed2cd6224193052ce665dc18165841),
