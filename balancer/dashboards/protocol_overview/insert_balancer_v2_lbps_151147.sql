...
-- query name: Insert Balancer V2 LBPs
-- query link: https://dune.com/queries/151147


DROP TABLE IF EXISTS dune_user_generated.balancer_v2_lbps;

CREATE TABLE dune_user_generated.balancer_v2_lbps (
    name text,
    pool_id bytea,
    token_sold bytea,
    token_symbol text,
...
INSERT INTO dune_user_generated.balancer_v2_lbps
SELECT 
    name,
    pool_id,
    token AS token_sold,
