...
-- query name: spell_balancer_v2_trades
-- query link: https://dune.com/queries/2632477
...
--select sum(amount_usd) from output --where block_time > NOW() - INTERVAL '24' hour

select * from dexs where block_time > NOW() - INTERVAL '10' hour
