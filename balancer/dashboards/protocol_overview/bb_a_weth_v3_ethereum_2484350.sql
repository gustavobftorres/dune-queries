...
-- query name: bb-a-WETH v3  (ETHEREUM)
-- query link: https://dune.com/queries/2484350
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0x60d604890feaa0b5460b28a424407c24fe89374a0000000000000000000004fc] AS pool_ids)
