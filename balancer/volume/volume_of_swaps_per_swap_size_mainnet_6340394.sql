...
-- query name: Volume of Swaps per Swap Size (Mainnet)
-- query link: https://dune.com/queries/6340394
...
WITH category_swap as (
    ...
    WHERE 
        ...
        block_time >= TIMESTAMP '2026-01-14 12:00:00' AND block_time <= TIMESTAMP '2026-01-15 12:00:00'
),
total_swap as (
    SELECT
