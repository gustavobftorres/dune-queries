...
-- query name: (DEPRECATED) Balancer Volume by Source on Mainnet
-- query link: https://dune.com/queries/22281
...
WITH gnosis_labels AS (
    ...
    manual_labels AS (
        ...
        UNION ALL
        SELECT '\x1111111254eeb25477b68fb85ed929f73a960582', '1inch'
    ),
