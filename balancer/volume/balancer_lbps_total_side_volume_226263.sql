...
-- query name: Balancer LBPs Total Side Volume
-- query link: https://dune.com/queries/226263
...
SELECT 
    SUM(COALESCE(z.direct_spent, 0)) lbp_volume, 
    SUM(COALESCE(p.indirect_spent, 0) + COALESCE(s.indirect_spent,0)) as side_volume
