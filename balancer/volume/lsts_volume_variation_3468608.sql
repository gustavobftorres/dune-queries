...
-- query name: LSTs Volume Variation
-- query link: https://dune.com/queries/3468608
...
trades AS (
    ...
    END AS date, 
        CASE WHEN '{{4. Currency}}' = 'USD' THEN SUM(amount_usd)
             WHEN '{{4. Currency}}' = 'eth' THEN SUM(amount_usd / median_price_eth)
        END AS amount_usd
