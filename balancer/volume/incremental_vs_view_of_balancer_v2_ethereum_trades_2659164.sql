...
-- query name: incremental vs view of balancer_v2_ethereum.trades
-- query link: https://dune.com/queries/2659164
...
SELECT 'view' AS spell_type, count(*) FROM output WHERE block_date >= current_date - INTERVAL '7' DAY 
UNION
SELECT 'incremental' AS spell_type, count(*) FROM balancer_v2_ethereum.trades WHERE block_date >= current_date - INTERVAL '7' DAY 