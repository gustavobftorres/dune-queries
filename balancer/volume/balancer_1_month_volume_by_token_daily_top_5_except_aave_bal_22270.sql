...
-- query name: Balancer 1-month Volume by Token (daily top 5 except AAVE, BAL, DAI, USDC, WBTC & WETH) (Dune SQL)
-- query link: https://dune.com/queries/22270


-- Volume (token breakdown without AAVE, BAL, DAI, USDC, WBTC & WETH) per day (full)
