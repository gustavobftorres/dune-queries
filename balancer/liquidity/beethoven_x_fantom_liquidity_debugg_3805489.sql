...
-- query name: beethoven x fantom liquidity debugg
-- query link: https://dune.com/queries/3805489
...
WITH pool_labels AS (
        SELECT
            ...
            name AS pool_symbol,
            pool_type
        FROM labels.beethoven_x_pools_fantom
    ...
    bpt_prices AS(
        SELECT DISTINCT
            ...
            decimals,
            bpt_price
        FROM beethoven_x_fantom.bpt_prices
        WHERE blockchain = 'fantom'
    ),
    ...
    swaps_changes AS (
        ...
        FROM
            (
                ...
                FROM beethoven_x_fantom.Vault_evt_Swap
    ...
    zipped_balance_changes AS (
        ...
        FROM beethoven_x_fantom.Vault_evt_PoolbalanceChanged
    ...
    managed_changes AS (
        ...
        FROM beethoven_x_fantom.Vault_evt_PoolbalanceManaged
    ),
   ...
   cumulative_usd_balance AS (
    ...
    weighted_pool_liquidity_estimates AS (
        ...
        LEFT JOIN beethoven_x_fantom.pools_tokens_weights w ON b.pool_id = w.pool_id 
