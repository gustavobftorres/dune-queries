...
-- query name: v3_liquidity
-- query link: https://dune.com/queries/4428144


WITH gnosis_liquidity AS(
WITH pool_labels AS (
        SELECT
            address AS pool_id,
            name AS pool_symbol,
    ...
    swaps_changes AS (
        ...
        FROM
            (
                ...
                FROM balancer_v3_gnosis.Vault_evt_Swap
        ...
        FROM
            (
                SELECT
                    ...
                    swapFeeAmountsRaw
                FROM balancer_v3_gnosis.Vault_evt_LiquidityAdded
                ...
                SELECT
                    ...
                    swapFeeAmountsRaw
                FROM balancer_v3_gnosis.Vault_evt_LiquidityRemoved
            ) adds_and_removes
    ),
...
WITH pool_labels AS (
   ...
   cumulative_usd_balance AS (
    ...
    SELECT * FROM gnosis_liquidity
    UNION
    SELECT * FROM ethereum_liquidity