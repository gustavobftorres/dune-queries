...
-- query name: Fraxtal TVL by Pool, Current Top 5 Pools
-- query link: https://dune.com/queries/3900033
...
top_pools AS (
    ...
    WHERE day = (SELECT MAX(CAST(day AS TIMESTAMP)) - INTERVAL '1' day FROM dune.balancer.dataset_fraxtal_snapshots)
    ORDER BY 3 DESC
    LIMIT 5
)
