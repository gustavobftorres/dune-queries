...
-- query name: Balancer Pools Analysis on Polygon
-- query link: https://dune.com/queries/100243
...
SELECT 
    ...
    CONCAT('<a target="_blank" href="https://polygonscan.com/address/0', SUBSTRING(pool::text, 2, 42), '">polygonscan ↗</a>') AS polygonscan
FROM last_tvl p
