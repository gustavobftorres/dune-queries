...
-- query name: Balancer V2 LBPs Overview
-- query link: https://dune.com/queries/226255
...
FROM dex.trades t
INNER JOIN lbps l 
ON SUBSTRING(l.pool_id,1,42) = CAST(t.project_contract_address as varchar) AND l.blockchain = t.blockchain
