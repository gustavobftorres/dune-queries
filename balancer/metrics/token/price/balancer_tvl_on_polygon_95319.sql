...
-- query name: Balancer TVL on Polygon
-- query link: https://dune.com/queries/95319
...
WITH prices AS (
        ...
        SELECT 
            generate_series('2021-11-14'::timestamp, CURRENT_DATE, '1 day'::interval) AS day,
            '\x2e1AD108fF1D8C782fcBbB89AAd783aC49586756' AS token,
            18 AS decimals,
            1.00 AS price
    ),
    ...
    cumulative_usd_balance AS (
        ...
        RIGHT JOIN prices p1 ON p1.day = c.day AND p1.token = b.token
    ),
