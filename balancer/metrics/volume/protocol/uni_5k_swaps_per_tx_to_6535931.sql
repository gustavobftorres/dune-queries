...
-- query name: Uni 5K swaps per tx_to
-- query link: https://dune.com/queries/6535931
...
WITH category_swap as (
    ...
    WHERE 
        ...
        -- project = 'uniswap' AND 
        -- version = '3' AND
        -- project_contract_address != 0x9d1fcf346ea1b073de4d5834e25572cc6ad71f4d AND
