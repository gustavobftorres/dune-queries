...
-- query name: cbBTC/WETH reCLAMM Volume by Source (Base)
-- query link: https://dune.com/queries/5972928
...
WITH 
    raw_swaps AS (
        ...
        AND project_contract_address = 0x19aeb8168d921bb069c6771bbaff7c09116720d0
