...
-- query name: pmusd/frxusd kyber orders breakdown
-- query link: https://dune.com/queries/6926437
...
WITH kyber_curve_txs AS (
    ...
    WHERE agg.blockchain = 'ethereum'
        ...
        AND dex.project_contract_address = 0xbf5047039f2980c21eb5692c790bad8a9533b900 -- curve pool 
)
...
SELECT 
    ...
    COUNT(CASE WHEN amount_usd < 1000 THEN 1 END) as count_under_1k,
    ...
    COUNT(CASE WHEN amount_usd >= 100000 THEN 1 END) as count_over_100k,
