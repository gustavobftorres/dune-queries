...
-- query name: CoW AMM vs Uni Pool vs Token Rebalancing Fork v2
-- query link: https://dune.com/queries/4844142
...
competitors as (
    select
        ...
        i.project,
        i.created_at,
            greatest(min(i.day), date_trunc('day', timestamp '{{start}}')) as "start"
