...
-- query name: Liquidity on LST/LRT Pools
-- query link: https://dune.com/queries/3920718
...
tvl AS (
    ...
    FROM balancer.liquidity p
        ...
        LEFT JOIN labels.balancer_v2_pools_optimism ol ON ol.address = l.address AND ol.blockchain = l.blockchain
    WHERE
