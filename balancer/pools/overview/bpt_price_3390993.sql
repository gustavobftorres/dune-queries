...
-- query name: bpt price
-- query link: https://dune.com/queries/3390993
...
WITH pool_labels AS (
   ...
   cumulative_usd_balance AS (
    ...
    WHERE c.pool_id = 0x32df62dc3aed2cd6224193052ce665dc181658410002000000000000000003bd
    GROUP BY 1, 2, 3, 4
    )
    ...
    FROM tvl l
    LEFT JOIN balancer.bpt_supply s ON l.pool_address = s.token_address
