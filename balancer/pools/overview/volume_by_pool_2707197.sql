...
-- query link: https://dune.com/queries/2707197
...
SELECT 
    ...
    SUM(amount_usd)/1e6 AS volume_all_time
FROM balancer.trades 
WHERE ('{{1. Pool ID}}' = 'All' OR CAST(project_contract_address as varchar) = SUBSTRING('{{1. Pool ID}}',1,42)) 
