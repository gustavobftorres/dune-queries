...
-- query name: Balancer V2 LBP Indirect Volume
-- query link: https://dune.com/queries/151192
...
WITH lbp_info AS (
    ...
    lbp_volume as (
        ...
        AND l.pool_id = a.exchange_contract_address
    ...
    token_purchases AS (
        ...
        FROM dex.trades a
        INNER JOIN lbp_info l ON l.pool_id = a.exchange_contract_address
        INNER JOIN dex.trades b ON a.exchange_contract_address = l.pool_id
    ...
    token_sales AS (
        ...
        FROM dex.trades a
        INNER JOIN lbp_info l ON l.pool_id = a.exchange_contract_address
        INNER JOIN dex.trades b ON l.pool_id= a.exchange_contract_address
