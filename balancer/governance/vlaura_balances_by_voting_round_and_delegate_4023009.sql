...
-- query name: vlAURA balances by voting round and delegate
-- query link: https://dune.com/queries/4023009
...
agg AS (
    SELECT
        ...
        COALESCE(ud.delegate, BYTEARRAY_SUBSTRING(fru._user, 1, 3)) AS delegate,
    ...
    LEFT JOIN 
        ...
        AND fru.vlaura_round < ud.vlaura_round + 17)
        AND ud.rn = 1
