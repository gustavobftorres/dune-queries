...
-- query name: BAL Emissions and Fees Collected By Gauge, per Round of Emissions, no filters
-- query link: https://dune.com/queries/4104309
...
SELECT * FROM FINAL
WHERE (round_emissions > 0 OR round_fees > 0)
