...
-- query name: veBAL Votes by Gauge Test
-- query link: https://dune.com/queries/3304306


WITH

	parsed_data AS (SELECT CAST(address as VARCHAR) as gauge, name as label FROM test_schema.git_dunesql_89bd99a5_labels_balancer_v2_gauges), -- Gauge Labels
