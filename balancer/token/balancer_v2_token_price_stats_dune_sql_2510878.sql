...
-- query name: Balancer V2 Token Price Stats (Dune SQL)
-- query link: https://dune.com/queries/2510878
...
WITH
  ...
  pool_token_price AS (
    ...
    FROM
      ...
      LEFT JOIN tokens.erc20 AS t ON t.contract_address = l.token_sold AND t.blockchain = l.blockchain
    WHERE
