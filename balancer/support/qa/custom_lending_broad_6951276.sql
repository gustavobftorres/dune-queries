...
-- query name: custom_lending_broad
-- query link: https://dune.com/queries/6951276



SELECT blockchain, 
       CONCAT('0x', LOWER(CAST(ENCODE(address, 'hex') AS VARCHAR))) as address,
       bytearray_length(code) as code_size
FROM evms.creation_traces
