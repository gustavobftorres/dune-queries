...
-- query name: exporting to csv - historical bal emissions
-- query link: https://dune.com/queries/3981781
...
AND b.day > TIMESTAMP '{{1. Start Date}}'
AND b.day < TIMESTAMP '{{2. End Date}}'
