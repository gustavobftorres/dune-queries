...
-- query name: (query_2276840) veBAL_daily_balances
-- query link: https://dune.com/queries/2276840


/*
queried on:
veBAL Metrics https://dune.com/queries/543807
veBAL Average Lock Time https://dune.com/queries/622204
veBAL by Top LPs https://dune.com/queries/601405
veBAL balance changes https://dune.com/queries/1200356
veBAL Holders https://dune.com/queries/782195
veBAL Power by Provider https://dune.com/queries/782249
*/
WITH base_locks AS (
    ...
    deposits AS (
        ...
        FROM balancer_ethereum.veBAL_evt_Deposit
        GROUP BY provider, date_trunc('day', evt_block_time)
    ),
