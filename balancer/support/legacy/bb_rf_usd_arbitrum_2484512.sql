...
-- query name: bb-rf-USD (ARBITRUM)
-- query link: https://dune.com/queries/2484512
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0xe1fb90d0d3b47e551d494d7ebe8f209753526b0100000000000000000000034e, 0x894c82800526e0391e709c0983a5aea3718b7f6d00000000000000000000034f, 0x5bae72b75caab1f260d21bc028c630140607d6e8000000000000000000000350] AS pool_ids)
