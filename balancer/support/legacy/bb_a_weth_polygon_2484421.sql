...
-- query name: bb-a-WETH (POLYGON)
-- query link: https://dune.com/queries/2484421
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0x43894de14462b421372bcfe445fa51b1b4a0ff3d000000000000000000000b36] AS pool_ids)
