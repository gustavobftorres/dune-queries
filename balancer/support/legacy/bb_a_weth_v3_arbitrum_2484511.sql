...
-- query name: bb-a-WETH v3 (ARBITRUM)
-- query link: https://dune.com/queries/2484511
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0xda1cd1711743e57dd57102e9e61b75f3587703da0000000000000000000003fc] AS pool_ids)
