...
-- query name: bb-a-WMATIC (POLYGON)
-- query link: https://dune.com/queries/2484420
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0xe4885ed2818cc9e840a25f94f9b2a28169d1aea7000000000000000000000b29] AS pool_ids)
