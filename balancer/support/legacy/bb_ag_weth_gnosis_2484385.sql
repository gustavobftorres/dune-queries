...
-- query name: bb-ag-WETH (GNOSIS)
-- query link: https://dune.com/queries/2484385
...
-----------------------------------------------------------------------------------
    ...
    pool_id_output AS (
        WITH 
            input AS (SELECT array[0xbb9cd48d33033f5effbedec9dd700c7d7e1dcf5000000000000000000000000e] AS pool_ids)
