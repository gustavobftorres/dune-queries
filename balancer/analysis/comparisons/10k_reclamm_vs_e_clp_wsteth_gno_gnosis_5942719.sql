...
-- query name: 10K reCLAMM vs E-CLP wstETH/GNO - Gnosis
-- query link: https://dune.com/queries/5942719
...
bpt_prices_eclp as (
    ...
    JOIN balancer.bpt_supply BS ON BS.day > now() - interval '30' day 
        ...
        AND BS.day = L.day 
    WHERE L.day >= TIMESTAMP '2025-09-25 00:00:00'
        AND L.pool_address = 0x9d376359b1c4975aae4907e540c76838547e2fe2
    GROUP BY L.day, L.pool_address
),
