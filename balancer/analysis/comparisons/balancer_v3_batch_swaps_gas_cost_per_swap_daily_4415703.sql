...
-- query name: Balancer V3 Batch Swaps Gas Cost per swap, Daily
-- query link: https://dune.com/queries/4415703
...
FROM
 ...
 GROUP BY 1,2,3,4,5
 ORDER BY 1 DESC, 5, 4 ASC, 10 DESC --order by day and median gas_per_swap