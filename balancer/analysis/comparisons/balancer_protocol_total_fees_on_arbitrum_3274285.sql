...
-- query name: Balancer Protocol & Total Fees on Arbitrum
-- query link: https://dune.com/queries/3274285
...
SELECT
    ...
    SUM(f.protocol_fee_collected_usd) as protocol_fee_usd,
    SUM(f.protocol_fee_collected_usd) / 0.5 as total_fee_usd
