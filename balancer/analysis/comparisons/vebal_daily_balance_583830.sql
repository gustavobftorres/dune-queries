...
-- query name: veBAL Daily Balance
-- query link: https://dune.com/queries/583830


DROP TABLE IF EXISTS dune_user_generated.balancer_vebal_slopes;

CREATE TABLE dune_user_generated.balancer_vebal_slopes (
...
INSERT INTO dune_user_generated.balancer_vebal_slopes
SELECT *
FROM slopes
