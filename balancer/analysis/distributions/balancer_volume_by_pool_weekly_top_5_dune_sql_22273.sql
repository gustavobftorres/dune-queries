...
-- query name: Balancer Volume by Pool (weekly top 5) (Dune SQL)
-- query link: https://dune.com/queries/22273
...
SELECT * FROM (
    SELECT
        ...
        CONCAT('v', version, ': ', '(', SUBSTRING(s.blockchain,1,3),'), (', SUBSTRING(s.address, 3, 8), ')'))
        AS pool,
        week,
        s.traders,
